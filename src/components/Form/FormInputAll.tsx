...
export default function FormInputAll({
  ...
  return (
    <div className="mt-1">
      ...
      <div className="flex mt-1 items-center transition justify-between  active:border-primary  border border-gray-300 rounded-lg focus:outline-none focus:ring-2  focus:ring-[#D72626] text-sm sm:text-base disabled:bg-gray-100 disabled:hover:border-gray-300 disabled:transition-none text-text-secondary active:scale-102 ease-out  hover:border-primary/70 ">
