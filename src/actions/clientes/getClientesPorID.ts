...
import {   ClienteBase, GetClientePorIDResponse } from "@/src/types/cliente/clientType";

export default async function getClientesPorID(id:string): Promise<GetClientePorIDResponse>  {
